...
//Launch
    ...
    public void penHelp(MouseDragEvent mouseDragEvent) {
    }
...
//needs work
    ...
    @FXML
    void r180(ActionEvent event) {
        canv.setRotate(canv.getRotate()+180);
    }

    @FXML
    void r270(ActionEvent event) {
        canv.setRotate(canv.getRotate()+270);
    }
    @FXML
    void r90(ActionEvent event) {
        canv.setRotate(canv.getRotate()+90);
    }
    @FXML
    void hort(ActionEvent event) {
